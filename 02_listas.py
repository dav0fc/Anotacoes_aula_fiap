...
def cria_naipe():
    ...
    for naipe in naipes:
        ...
        # cartas.append("Q")
        cartanaipe.append("K")
        for carta in cartanaipe:
            cartanova = str(carta)+naipe
            cartanaipe.append(cartanova)
        cartas.append(cartanaipe)
    return cartas
